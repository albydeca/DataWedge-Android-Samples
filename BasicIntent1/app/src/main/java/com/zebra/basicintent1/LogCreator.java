...
public class LogCreator {
    ...
    public void createChannel() throws IOException, JSONException {
    ...
    public void writeDataOnChannel() throws IOException, JSONException {
        CloseableHttpClient client = HttpClients.createDefault();
    ...
    public void getDataFromChannel() throws IOException, JSONException {
        CloseableHttpClient client = HttpClients.createDefault();
    ...
    public String getAllSubscriptions() throws IOException, JSONException {
        CloseableHttpClient client = HttpClients.createDefault();
    ...
    public void authorizedSubscriptions(String subscriptionLink) throws IOException, JSONException {
        CloseableHttpClient client = HttpClients.createDefault();
